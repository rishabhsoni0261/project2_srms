	...
	if(mysqli_num_rows($result) > 0)  
 	{
      ...
      {
?>
	<form action="insert_bca_result_backend.php?sem=<?php echo $sem?>" method="post">
		<div class="container">
			<center><h2>Add Result of BCA(Semester-<?php echo $sem?>)</h2></center>
      ...
      <label for="sname"><b>Course:</b></label>
        <input type="text" value="BCA" disabled><br>
