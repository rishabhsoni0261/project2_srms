...
$sql="SELECT * FROM tblstudent JOIN tblcourse WHERE tblstudent.stud_course = tblcourse.cid and tblstudent.stud_course=2";
...
<body>
	...
	<table style="border-collapse: collapse;width: 100%;">
		...
		<tr>
			...
			<td style="text-align: left; padding: 15px;"><a href="insert_msc_result.php?id=<?php echo $row['stud_id'];?>&&sem=<?php echo $sem?>" class="editbtn" style="width: auto; padding: 10px 18px; background-color: #66b3ff;" onclick="return confirm('Are you Sure to Add Sem- <?php echo $sem; ?> result')"><b>Add Sem <?php echo $sem?> result</b></a></td>
		</tr>
		<?php }?>
	</table>
	<?php
